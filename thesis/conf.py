...
project = u'AlphaTrainer - an Android based neurofeedback system using low-cost consumer Brain-Computer Interfaces'
projetc_short = u'AlphaTrainer'
author = u'Martin Poulsen and Pelle Krøgholt'
...
html_title = "%s" % projetc_short

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "%s" % projetc_short
...
# remeber the depth is the sphinx toc level depth -1
ADDITIONAL_PREAMBLE = """
...
latex_elements = {
    ...
    'classoptions': ',english,lof,lot,twoside',

    # The font size ('10pt', '11pt' or '12pt').
    'pointsize': '10pt',

    # Additional stuff for the LaTeX preamble.
    # For example setting depth of the toc
...
latex_appendices = [
    'appendix_background_testbench',
    'appendix_background_truesense_console',
    'appendix_experiment',
    'appendix_experiment_mindwave_fora_posts',
    'appendix_design_personas',
    'appendix_design_storyboards',
    'appendix_software',
    'appendix_evaluation'
]
